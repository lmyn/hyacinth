...
public class BaseModelGenerator {
    ...
    protected String importTemplate =
            "import com.github.hyacinth.Model;%n" +
                    "import com.github.hyacinth.Bean;%n" +
                    "import com.github.hyacinth.annotation.Table;%n" +
                    "import com.github.hyacinth.annotation.Column;%n" +
                    "import com.github.hyacinth.annotation.PrimaryKey;%n";
    protected String classDefineTemplate =
            "/**%n" +
                    " * Generated by hyacinth, do not modify this file.%n" +
                    " */%n" +
                    "@Table(name = \"%s\")%n" +
                    "public abstract class %s<M extends %s<M>> extends Model<M> implements Bean {%n%n";
    ...
    public BaseModelGenerator(String baseModelPackageName, String baseModelOutputDir) {
        if (StringTools.isBlank(baseModelPackageName)) {
        ...
        if (StringTools.isBlank(baseModelOutputDir)) {
...
//			genGetMethodName(columnMeta, ret);
    ...
    protected void genClassDefine(TableMeta tableMeta, StringBuilder ret) {
        ...
        ret.append(String.format(template, tableMeta.name, tableMeta.baseModelName, tableMeta.baseModelName));
    }

    protected void genSetMethodName(ColumnMeta columnMeta, StringBuilder ret) {
        String setterMethodName = "set" + StringTools.firstCharToUpperCase(columnMeta.attrName);
